    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('types', models.CharField(choices=[('government', 'Pemerintahan'), ('public_facility', 'Fasilitas Umum'), ('park', 'Taman'), ('restaurant', 'Restoran')], max_length=20)),
                ...
                ('price_unit', models.CharField(choices=[('hourly', 'Per jam'), ('daily', 'Per hari'), ('weekly', 'Per minggu'), ('montly', 'Per bulan'), ('annual', 'Per tahun')], max_length=15)),
